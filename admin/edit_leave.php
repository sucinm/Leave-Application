						...
						<tr>
							...
							<td>
								<select class="form-control"  name="type_of_leave">
									<option value="<?php echo $d['type_of_leave']; ?>"><?php echo $d['type_of_leave']; ?></option>
							...
							<td><input type="text" class="form-control" name="days" style="width:50px" value="<?php echo $d['total_days']; ?>">					</td>
