...
$pdf->Cell(4, 0.8, 'Name', 1, 0, 'C');
$pdf->Cell(1, 0.8, '1', 1, 0, 'C');
$pdf->Cell(1, 0.8, 'Taken', 1, 0, 'C');
$pdf->Cell(1, 0.8, '1', 1, 0, 'C');
...
$pdf->Cell(1, 0.8, 'Taken', 1, 0, 'C');
$pdf->Cell(1, 0.8, '3', 1, 0, 'C');
$pdf->Cell(1, 0.8, '4', 1, 0, 'C');
$pdf->Cell(1, 0.8, 'Taken', 1, 0, 'C');
$pdf->Cell(1, 0.8, '4', 1, 0, 'C');
$pdf->Cell(1, 0.8, '5', 1, 0, 'C');
$pdf->Cell(1, 0.8, 'Taken', 1, 0, 'C');
$pdf->Cell(1, 0.8, '5', 1, 0, 'C');
$pdf->Cell(1, 0.8, '6', 1, 0, 'C');
$pdf->Cell(1, 0.8, 'Taken', 1, 0, 'C');
$pdf->Cell(1, 0.8, '6', 1, 0, 'C');
$pdf->Cell(1, 0.8, '7', 1, 0, 'C');
$pdf->Cell(1, 0.8, 'Taken', 1, 0, 'C');
$pdf->Cell(1, 0.8, '7', 1, 0, 'C');
$pdf->Cell(1, 0.8, '8', 1, 0, 'C');
$pdf->Cell(1, 0.8, 'Taken', 1, 0, 'C');
$pdf->Cell(1, 0.8, '8', 1, 0, 'C');
$pdf->Cell(1, 0.8, '9', 1, 0, 'C');
$pdf->Cell(1, 0.8, 'Taken', 1, 0, 'C');
$pdf->Cell(1, 0.8, '9', 1, 0, 'C');
$pdf->Cell(1, 0.8, '10', 1, 0, 'C');
$pdf->Cell(1, 0.8, 'Taken', 1, 0, 'C');
$pdf->Cell(1, 0.8, '10', 1, 0, 'C');
...
while($lihat=mysql_fetch_array($query)){
    ...
    $pdf->Cell(4, 0.8, $lihat['name'], 1, 0,'C');
    $pdf->Cell(2, 0.8, $lihat['dept_name'],1, 0, 'C');
    ...
    $pdf->Cell(2, 0.8, $total_days, 1, 0,'C');
...
$pdf->Output("leave_balance_employee.pdf","I");
